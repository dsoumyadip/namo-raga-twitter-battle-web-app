    ...
    render() {
        ...
        return (
            <React.Fragment>
                <Paper>
                    <br/>
                    <Typography align='center' variant='h3' gutterBottom>Rahul vs Modi Live Positive Tweet Count</Typography>
                    <Divider/>
                    <br/>
                    <Chart
                        data={data}
                ...
                <Paper>
                    <br/>
                    <Typography align='center' variant='h3' gutterBottom>Rahul vs Modi Live Negative Tweet Count</Typography>
                    <Divider/>
                    <br/>
                    <Chart
                        data={data}
